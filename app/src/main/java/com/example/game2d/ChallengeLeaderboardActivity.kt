...
class ChallengeLeaderboardActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val sharedPrefs = getSharedPreferences("challenge_leaderboard", Context.MODE_PRIVATE)
...
class ChallengeLeaderboardAdapter(private val topTimes: List<Long>) : RecyclerView.Adapter<ChallengeLeaderboardAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.rankText.setTextColor(0xFFFFFF00.toInt())
